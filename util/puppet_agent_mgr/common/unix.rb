    ...
    module PuppetAgentMgr::Common
      module Unix
        ...
        def applying?
          ...
          return false unless File.exist?(agent_catalog_run_lockfile)

          if File::Stat.new(agent_catalog_run_lockfile).size > 0
            return has_process_for_pid?(File.read(agent_catalog_run_lockfile))
          end
